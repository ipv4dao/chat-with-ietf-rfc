...
If the question is not relaed to Internet development or IETF RFCs, politely inform them that you are tuned to only answer questions about the most recent state of the union.
Question: {question}
=========
{context}
=========
...
def get_chain(vectorstore):
    ...
    llm = OpenAI(temperature=0.1, model_name="gpt-4-0314")
